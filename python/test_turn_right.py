...
def test_rover_turns_right_when_facing_north():
...
def test_rover_turns_right_when_facing_east():
...
def test_rover_turns_right_when_facing_south():
...
def test_rover_turns_right_when_facing_west():
