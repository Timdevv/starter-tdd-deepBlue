...
def test_rover_moves_backward_when_facing_north():
...
def test_rover_moves_backward_when_facing_south():
    initial_position = Position(4, 2)
...
def test_rover_moves_backward_when_facing_east():
    initial_position = Position(4, 2)
...
def test_rover_moves_backward_when_facing_west():
    initial_position = Position(4, 2)
